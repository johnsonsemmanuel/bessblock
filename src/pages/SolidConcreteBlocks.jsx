...
export default function SolidConcreteBlocks() {
  return (
    <>
      ...
      <div className="page">
      <PageHero title="Solid Concrete Blocks" description="Dense solid concrete blocks for foundations and load-bearing walls requiring high strength and durability." bgImage="/images/products/solid-blocks-1.webp" />
