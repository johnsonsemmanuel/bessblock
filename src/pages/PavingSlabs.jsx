      ...
      <section className="section">
        <div className="container">
          ...
          <div className="subcategory-grid">
              {[
                { ...cat.subcategories[0], image: '/images/products/textured-paving-slabs.webp' },
                { ...cat.subcategories[1], image: '/images/products/smooth-paving-slabs.webp' },
                { ...cat.subcategories[2], image: '/images/products/large-format-slabs.webp' },
              ].map(sub => (
