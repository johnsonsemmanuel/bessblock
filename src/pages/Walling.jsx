        ...
        <div className="container">
          ...
          <div className="walling-sub-grid">
              {[
                ...
                { ...cat.subcategories[3], image: '/images/products/retaining-walls.jpg' },
                { ...cat.subcategories[4], image: '/images/products/l-range-rock-face.jpg' },
                { ...cat.subcategories[5], image: '/images/products/4x4-step-block.jpg' },
