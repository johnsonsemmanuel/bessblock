      ...
      <section className="section">
        <div className="container">
          ...
          <div className="subcategory-grid">
              {[
                { ...cat.subcategories[0], image: '/images/products/standard-step-risers.webp' },
                { ...cat.subcategories[1], image: '/images/products/wide-tread-steps.webp' },
                { ...cat.subcategories[2], image: '/images/products/bullnose-steps.webp' },
              ].map(sub => (
